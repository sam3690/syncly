...
class GoogleSheetsIngestor(BaseIngestor):
    ...
    def fetch_updates(
        ...
        _LOGGER.info(
            "Fetching Google Sheets updates for workspace %s since %s",
            workspace_id,
            last_synced_at,
        )
